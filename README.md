...
This project has been upgraded to a modern architecture consisting of a **React Frontend** and a **FastAPI Backend**. To run the project locally:

1. **Start the Backend:**
   ```bash
   cd Backend
   agrisens_env\Scripts\activate
